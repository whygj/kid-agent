...
from kid_agent.knowledge.naming import validate_knowledge_base_name
from kid_agent.knowledge.progress_tracker import ProgressStage, ProgressTracker
from kid_agent.services.rag.factory import DEFAULT_PROVIDER
from kid_agent.services.rag.file_routing import FileTypeRouter
from kid_agent.services.rag.service import RAGService
...
class KnowledgeBaseInitializer:
    ...
    def _register_to_config(self) -> None:
        ...
        try:
            from kid_agent.knowledge.manager import KnowledgeBaseManager
