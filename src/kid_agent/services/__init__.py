...
Usage:
    from kid_agent.services.llm import get_llm_client
    from kid_agent.services.embedding import get_embedding_client
    from kid_agent.services.rag import RAGService
    from kid_agent.services.prompt import get_prompt_manager
    from kid_agent.services.search import web_search
    from kid_agent.services.setup import init_user_directories
