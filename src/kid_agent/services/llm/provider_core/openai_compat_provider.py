...
from kid_agent.services.llm.capabilities import disable_response_format_at_runtime
from kid_agent.services.llm.openai_http_client import openai_client_kwargs
from kid_agent.services.llm.provider_core.base import LLMProvider, LLMResponse, ToolCallRequest
from kid_agent.services.llm.provider_core.openai_responses import (
...
if TYPE_CHECKING:
    from kid_agent.services.provider_registry import ProviderSpec
