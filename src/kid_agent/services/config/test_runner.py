...
from kid_agent.services.llm.client import reset_llm_client
from kid_agent.services.llm.config import clear_llm_config_cache
...
class ConfigTestRunner:
    ...
    def _persist_embedding_dimension(
        ...
        use the new dim.
        """
        from kid_agent.services.embedding.client import reset_embedding_client
    ...
    async def _test_llm(self, run: TestRun, catalog: dict[str, Any]) -> None:
        from kid_agent.services.llm import clear_llm_config_cache, get_token_limit_kwargs
        from kid_agent.services.llm import complete as llm_complete
    ...
    async def _test_embedding(
        ...
        from kid_agent.services.embedding.client import EmbeddingClient
        from kid_agent.services.embedding.config import EmbeddingConfig
    ...
    def _test_search(self, run: TestRun, catalog: dict[str, Any]) -> None:
        from kid_agent.services.search import web_search
