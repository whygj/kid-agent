...
from kid_agent.core.capability_protocol import BaseCapability
from kid_agent.runtime.bootstrap.builtin_capabilities import BUILTIN_CAPABILITY_CLASSES
...
def _load_plugin_hooks():
    try:
        module = importlib.import_module("kid_agent.plugins.loader")
    except Exception:
