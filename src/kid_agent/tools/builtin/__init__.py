...
from kid_agent.core.tool_protocol import BaseTool, ToolDefinition, ToolParameter, ToolResult
from kid_agent.tools.prompting import load_prompt_hints
...
class BrainstormTool(_PromptHintsMixin, BaseTool):
    ...
    async def execute(self, **kwargs: Any) -> ToolResult:
        from kid_agent.tools.brainstorm import brainstorm
...
class RAGTool(_PromptHintsMixin, BaseTool):
    ...
    async def execute(self, **kwargs: Any) -> ToolResult:
        from kid_agent.tools.rag_tool import rag_search
...
class WebSearchTool(_PromptHintsMixin, BaseTool):
    ...
    async def execute(self, **kwargs: Any) -> ToolResult:
        from kid_agent.tools.web_search import web_search
...
"""
    ...
    async def execute(self, **kwargs: Any) -> ToolResult:
        from kid_agent.tools.code_executor import run_code
    ...
    async def _generate_code(self, intent: str) -> str:
        from kid_agent.services.llm import complete, get_token_limit_kwargs
        from kid_agent.services.llm.config import get_llm_config
...
class ReasonTool(_PromptHintsMixin, BaseTool):
    ...
    async def execute(self, **kwargs: Any) -> ToolResult:
        from kid_agent.tools.reason import reason
...
class PaperSearchToolWrapper(_PromptHintsMixin, BaseTool):
    ...
    async def execute(self, **kwargs: Any) -> ToolResult:
        from kid_agent.tools.paper_search_tool import ArxivSearchTool
...
class GeoGebraAnalysisTool(_PromptHintsMixin, BaseTool):
    ...
    async def execute(self, **kwargs: Any) -> ToolResult:
        from kid_agent.agents.vision_solver.vision_solver_agent import VisionSolverAgent
        from kid_agent.services.llm.config import get_llm_config
