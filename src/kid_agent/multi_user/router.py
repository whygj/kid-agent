...
from kid_agent.api.routers.auth import require_admin
from kid_agent.knowledge.manager import KnowledgeBaseManager
from kid_agent.services.config.model_catalog import ModelCatalogService
...
async def assign_space_template(
    ...
    (target / ".kid_agent_provenance.json").write_text(
