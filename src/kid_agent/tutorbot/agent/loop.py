...
from kid_agent.tutorbot.agent.memory import MemoryConsolidator
from kid_agent.tutorbot.agent.subagent import SubagentManager
from kid_agent.tutorbot.agent.team import TeamManager
from kid_agent.tutorbot.agent.team.tools import TeamTool
from kid_agent.tutorbot.agent.tools.cron import CronTool
from kid_agent.tutorbot.agent.tools.message import MessageTool
from kid_agent.tutorbot.agent.tools.registry import ToolRegistry, build_base_tools
from kid_agent.tutorbot.agent.tools.spawn import SpawnTool
...
from kid_agent.tutorbot.session.manager import Session, SessionManager

if TYPE_CHECKING:
    from kid_agent.tutorbot.config.schema import ChannelsConfig, ExecToolConfig, WebSearchConfig
...
class AgentLoop:
    ...
    def __init__(
        ...
        from kid_agent.tutorbot.config.schema import ExecToolConfig, WebSearchConfig
    ...
    def _register_default_tools(self) -> None:
        ...
        from kid_agent.tutorbot.agent.tools.kid_agent_tools import (
    ...
    async def _connect_mcp(self) -> None:
        ...
        from kid_agent.tutorbot.agent.tools.mcp import connect_mcp_servers
