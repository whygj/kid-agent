...
from kid_agent.tutorbot.agent.tools.registry import build_base_tools
...
from kid_agent.tutorbot.utils.helpers import (
    ensure_dir,
    parse_json_from_llm,
    safe_filename,
    timestamp,
...
if TYPE_CHECKING:
    from kid_agent.tutorbot.agent.tools.registry import ToolRegistry
