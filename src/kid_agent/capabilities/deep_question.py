...
from kid_agent.core.trace import merge_trace_metadata
...
class DeepQuestionCapability(BaseCapability):
    ...
    async def run(self, context: UnifiedContext, stream: StreamBus) -> None:
        from kid_agent.agents.question.coordinator import AgentCoordinator
        ...
        if isinstance(followup_question_context, dict) and followup_question_context.get(
            ...
            from kid_agent.agents.question.agents.followup_agent import FollowupAgent
