...
from kid_agent.core.trace import derive_trace_metadata, merge_trace_metadata, new_call_id
...
class DeepResearchCapability(BaseCapability):
    ...
    async def run(self, context: UnifiedContext, stream: StreamBus) -> None:
        from kid_agent.agents.research.request_config import (
            build_research_runtime_config,
            validate_research_request_config,
        )
        from kid_agent.agents.research.research_pipeline import ResearchPipeline
        from kid_agent.capabilities._answer_now import extract_answer_now_context
        from kid_agent.services.config import load_config_with_main
