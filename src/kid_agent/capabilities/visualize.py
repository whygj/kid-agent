...
class VisualizeCapability(BaseCapability):
    ...
    async def run(self, context: UnifiedContext, stream: StreamBus) -> None:
        from kid_agent.agents.visualize.pipeline import VisualizePipeline
        from kid_agent.agents.visualize.utils import (
            build_fallback_html,
        ...
        async with stream.stage("reviewing", source=self.name):
            if analysis.render_type == "html":
                ...
                from kid_agent.agents.visualize.models import ReviewResult
