...
from kid_agent.agents.research.agents import (
    DecomposeAgent,
    ManagerAgent,
    NoteAgent,
    RephraseAgent,
...
from kid_agent.agents.research.data_structures import DynamicTopicQueue
from kid_agent.agents.research.utils.citation_manager import CitationManager
from kid_agent.core.trace import new_call_id
from kid_agent.runtime.registry.tool_registry import get_tool_registry
from kid_agent.services.config import PROJECT_ROOT
...
class ResearchPipeline:
    ...
    async def run(self, topic: str) -> dict[str, Any]:
        ...
        try:
            ...
            try:
                from kid_agent.agents.research.utils.token_tracker import get_token_tracker
    ...
    async def _phase2_researching_parallel(self):
        ...
        from kid_agent.agents.research.data_structures import TopicStatus
...
async def main():
    ...
    from kid_agent.services.llm import get_llm_config
