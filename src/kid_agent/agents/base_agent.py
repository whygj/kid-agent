...
from kid_agent.config.settings import settings
from kid_agent.logging import LLMStats
from kid_agent.services.config import get_agent_params
...
class BaseAgent(ABC):
    ...
    def __init__(
        ...
        self.logger = logging.getLogger(f"kid_agent.{logger_name}")
