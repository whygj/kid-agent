...
from kid_agent.core.trace import (
    build_trace_metadata,
    derive_trace_metadata,
    merge_trace_metadata,
    new_call_id,
)
from kid_agent.runtime.registry.tool_registry import get_tool_registry
from kid_agent.services.config import get_chat_params
from kid_agent.services.llm import (
    clean_thinking_tags,
    get_llm_config,
...
from kid_agent.services.prompt import get_prompt_manager
from kid_agent.services.prompt.language import append_language_directive
from kid_agent.tools.builtin import BUILTIN_TOOL_NAMES
from kid_agent.utils.json_parser import parse_json_response
...
class AgenticChatPipeline:
    ...
    def __init__(self, language: str = "en") -> None:
        ...
        # Prompts live in kid_agent/agents/chat/prompts/{zh,en}/agentic_chat.yaml
    ...
    def _extract_answer_now_context(context: UnifiedContext) -> dict[str, Any] | None:
        ...
        from kid_agent.capabilities._answer_now import extract_answer_now_context
