...
from kid_agent.runtime.registry.tool_registry import ToolRegistry as CoreToolRegistry
from kid_agent.runtime.registry.tool_registry import get_tool_registry

if TYPE_CHECKING:
    from kid_agent.core.tool_protocol import ToolResult
...
class SolveToolRuntime:
    ...
    async def execute(
        ...
        *,
        ...
        from kid_agent.core.tool_protocol import ToolResult as _ToolResult
